...
@section('title', 'About Us - Jataparking')
@section('content')

<link rel="stylesheet" href="/Assets/css/main/aboutus.css">

<div class="head_aboutus">
    <div class="sub1_head_aboutus">
        <img src="/Assets/Images/line-aboutus.svg" alt="">
        <h1 style="color: #FFFFFF">Company Profile</h1>
    </div>
    <div class="sub2_head_aboutus">
...
<div class="content_aboutus">
    ...
    <div class="sub2_ct_aboutus">
        ...
        <div class="container_aboutus">
            ...
            <h2 class="blue_small">Our Vision</h2>
        ...
        <div class="container_aboutus">
            <img src="/Assets/Images/eye-white.svg" alt="">
